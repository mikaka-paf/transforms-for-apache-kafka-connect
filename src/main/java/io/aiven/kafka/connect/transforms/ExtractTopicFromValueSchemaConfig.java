...
public class ExtractTopicFromValueSchemaConfig extends AbstractConfig {
    public static final String SCHEMA_NAME_TO_TOPIC = "SchemaNameToTopicMap";
    public static final String REGEX_SCHEMA_NAME_TO_TOPIC = "RegExSchemaNameToTopicMap";
    ...
    Optional<Map<String, String>> schemaNameToTopicMap() {
        ...
        if (null == schemaNameToTopicMap || schemaNameToTopicMap.isEmpty()) {
            return Optional.empty();
        }
